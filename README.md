...
- [6. Configuring Windows VM for vGPU](#6-configuring-windows-vm-for-vgpu)
  - [6.1 Setting Up Remote Access](#61-setting-up-remote-access)
  - [6.2 Passing vGPU to VM](#62-passing-vgpu-to-vm)
  - [6.3 Updating VM Network Adapter](#63-updating-vm-network-adapter)
  - [6.4 Installing NVIDIA GRID Client Driver](#64-installing-nvidia-grid-client-driver)
